...
* **notifications:** update notification preferences and types ([#46](https://github.com/slightlyprivate/petcare-companion/issues/46)) ([a76cd99](https://github.com/slightlyprivate/petcare-companion/commit/a76cd99c3a4fcbee242aff9208b07afeacfefcc3))
...
* **docs:** add concise PRD and deployment guide for production setup ([6042889](https://github.com/slightlyprivate/petcare-companion/commit/60428897a44f5e367d4968ef045a007094e59906))

## [0.12.0](https://github.com/slightlyprivate/petcare-companion/compare/0.11.0...0.12.0) (2025-12-05)


### Features

* update image tagging strategy for staging and development environments ([5753987](https://github.com/slightlyprivate/petcare-companion/commit/57539875742074f212f6bafee9f811e29bddaf65))
...
* standardize entrypoint scripts to use /bin/sh and remove set -e ([34cf4b6](https://github.com/slightlyprivate/petcare-companion/commit/34cf4b6534a3e1e4551ad3e1b3106d58c7771a0c))
* Update entrypoint scripts for Laravel and add storage setup script ([97bcc91](https://github.com/slightlyprivate/petcare-companion/commit/97bcc91ae61173fb6fc5020db6d8ca4f91b61dd8))
