...
@section('content')
	...
	<p style="margin:0 0 14px 0;font-size:16px;line-height:24px;color:#374151;">Your personal data export is ready. It contains your user information, pets, gifts, and appointments in a secure ZIP file.</p>
	...
	<div style="margin:0 0 14px 0;padding:12px 14px;border:1px solid #e5e7eb;border-radius:10px;background-color:#f8fafc;">
		...
		<ul style="margin:8px 0 0 18px;padding:0;font-size:15px;line-height:22px;color:#374151;">
			...
			<li>Appointments for your pets</li>
		</ul>
	</div>
	...
	<p style="margin:0 0 8px 0;font-size:14px;line-height:22px;color:#6b7280;">This link is valid for 7 days.</p>
