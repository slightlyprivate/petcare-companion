    ...
    <Section title="Pets">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        >
          ...
          />
          {createPet.isError && (
            <ErrorMessage message={(createPet.error as { message?: string })?.message || 'Error'} />
          )}
          <Button
            size="sm"
        ...
        >
          ...
          />
          {updatePet.isError && (
            <ErrorMessage message={(updatePet.error as { message?: string })?.message || 'Error'} />
          )}
          <Button
            size="sm"
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        >
          ...
          />
          {deletePet.isError && (
            <ErrorMessage message={(deletePet.error as { message?: string })?.message || 'Error'} />
          )}
