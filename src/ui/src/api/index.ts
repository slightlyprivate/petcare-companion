export * as qk from './queryKeys';

export * as auth from './auth/client';
export * as authHooks from './auth/hooks';
...
export * as gifts from './gifts/client';
export * as giftHooks from './gifts/hooks';

export * as credits from './credits/client';
export * as creditHooks from './credits/hooks';
